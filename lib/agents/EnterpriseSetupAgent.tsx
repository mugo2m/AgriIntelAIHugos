...
function getSpacingOptionsForCrop(cropKey: string): { label: string; value: string }[] {
  ...
  console.log(`🔍 Looking for spacing for crop: "${normalized}"`); // DEBUG – remove if needed
...
// ===== DEFAULT EXPORT =====
export default class EnterpriseSetupAgent extends BaseInterviewAgent {
  constructor() {
    super();
    ...
    this.questions = [
      ...
      // 2. Main Crop – full list (matching spacing database keys)
      {
        id: "crops",
        type: "select",
