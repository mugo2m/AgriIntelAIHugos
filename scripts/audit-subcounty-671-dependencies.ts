...
async function main() {
  console.log("==============================================");
  console.log("READ-ONLY AUDIT: SUBCOUNTY 671");
  console.log("==============================================\n");
  ...
  if (
    ...
    console.log(
      "RESULT: SubCounty 671 is completely orphaned."
    );
    console.log(
    ...
    console.log(
      "RESULT: SubCounty 671 has dependencies or requires further investigation."
    );
    console.log(
      "NO DELETION WAS PERFORMED."
    );
