...
async function main() {
  console.log("==============================================");
  console.log("READ-ONLY AUDIT: SUBCOUNTY 667");
  console.log("==============================================\n");
  ...
  if (
    ...
    console.log(
      "RESULT: SubCounty 667 is completely orphaned."
    );
    console.log(
    ...
    console.log(
      "RESULT: SubCounty 667 has dependencies or requires further investigation."
    );
    console.log(
      "NO DELETION WAS PERFORMED."
    );
