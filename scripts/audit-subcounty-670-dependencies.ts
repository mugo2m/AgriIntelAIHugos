...
async function main() {
  console.log("==============================================");
  console.log("READ-ONLY AUDIT: SUBCOUNTY 670");
  console.log("==============================================\n");
  ...
  if (
    ...
    console.log(
      "RESULT: SubCounty 670 is completely orphaned."
    );
    console.log(
    ...
    console.log(
      "RESULT: SubCounty 670 has dependencies or requires further investigation."
    );
    console.log(
      "NO DELETION WAS PERFORMED."
    );
